...
_Note:_ 
_This only works at the widget level as this is essentially a fragment caching utility, and will not work for widgets rendered directly from a controller. (widget vs render_widget)_
...
_Note:_
_Lawnchair will automatically condense spaces, so don't feel constrained to using underscores or dashes in keys._
